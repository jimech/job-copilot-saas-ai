...
Run the [auth QA checklist](auth-qa-checklist.md) after changing auth, proxy, onboarding, or navigation code.
...
For the full authentication test plan, see [auth-qa-checklist.md](auth-qa-checklist.md).
